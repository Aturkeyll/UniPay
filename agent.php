...
// caller supplied their own student number, so the ID space could be walked
// for payment tokens. Now they must have followed a one-time link sent to the
