...
// Identity comes from the session. A manual payment files a record against a
// student's account, so it needs the same proof as everything else: the student
// must have followed a one-time link sent to the address already on file.
