...
<?php require 'header.php'; ?>
    ...
    <table class="staff-table">
        ...
        <tr>
            ...
            <td><form method="post" action="send_reminder.php" style="display:inline;"><?= csrfField() ?><input type="hidden" name="link_id" value="<?= $o['id'] ?>"><button type="submit">Send reminder</button></form></td>
        </tr>
        <?php endforeach; ?>
